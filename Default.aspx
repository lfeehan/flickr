...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div class = 'container'>
        ...
        <div style="margin:0 auto;">
                ...
                <h2 style="margin-top: 5px;">Drag Here</h2>
	            <p>...to save</p>
            ...
            <asp:TemplateField HeaderText="recent" >
                <ItemTemplate>
                     <a id="A1" class="group" href='<%# Eval("mainimg")%>' runat="server">
                        <img src='<%# Eval("image")%>' runat="server" style="height: 50%; width: 50%;">
                    </a>
                </ItemTemplate>
            </asp:TemplateField>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT TOP 6 [image], [mainimg], [tag], [id] FROM [saves] Order BY [id] DESC"></asp:SqlDataSource>
    ...
    <div class="csharp">
        <asp:Panel ID="Panel1" runat="server" DefaultButton="searchButton" >
            <p>
                <asp:TextBox ID="searchBox" class="textbox" runat="server" Text="enter a search term"  Width="161px" ></asp:TextBox>
            </p>
            <p>
                <asp:Button ID="searchButton" runat="server" Text="Search Flickr..." OnCommand="leftButton_Click" />
            </p>
        </asp:Panel>
    </div>
    <br />
